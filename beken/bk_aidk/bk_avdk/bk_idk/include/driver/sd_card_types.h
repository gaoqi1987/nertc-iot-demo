...
/**
 * @brief current card is used by which owner, I.E:USB device(PC connect USB to access SDCARD), or local file system.
 */
typedef enum {
	SD_CARD_OWNER_LOCAL_FS,
	SD_CARD_OWNER_USB_DEVICE,
	SD_CARD_OWNER_ERR,
} sd_card_owner_t;
