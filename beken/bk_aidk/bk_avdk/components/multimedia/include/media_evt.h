...
typedef enum
{
	...
	EVENT_LVGL_LVCAM_OPEN_IND,
	EVENT_LVGL_LVCAM_CLOSE_IND,
	EVENT_LVGL_SEND_DATA_IND,
	EVENT_LVGL_SWITCH_UI_IND,
    ...
    EVENT_AUD_PROMPT_TONE_PLAY_FINISH_NOTIFY,
    ...
    EVENT_BT_NOTIFY_TONE_STATUS_REQ,
	...
	EVENT_AVI_PLAY_START_IND = (AVI_PLAY_EVENT << MEDIA_EVT_BIT ),
	EVENT_AVI_PLAY_STOP_IND,
} media_event_t;
