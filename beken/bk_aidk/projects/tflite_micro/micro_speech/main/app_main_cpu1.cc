...
void tflite_task(void *arg){
    ...
    data_ptr = (unsigned char*)psram_malloc(g_micro_speech_quantized_model_data_len);
    if(data_ptr == NULL)
    {
    ...
    os_memcpy(data_ptr, g_micro_speech_quantized_model_data, g_micro_speech_quantized_model_data_len);
