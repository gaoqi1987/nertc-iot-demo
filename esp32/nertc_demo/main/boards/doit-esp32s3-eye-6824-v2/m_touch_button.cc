...
/*
    按钮
*/
bool head_button_pressed = false;
bool body_button_pressed = false;
void NotifyTouch() {
#if CONFIG_CONNECTION_TYPE_NERTC
    int value_head = head_button_pressed ? 1 : 0;
    int value_body = body_button_pressed ? 1 : 0;
    Application::GetInstance().TouchActive(value_head, value_body);
#endif
}
